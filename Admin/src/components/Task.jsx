...
const Task = ({ task }) => {
  ...
  return (
    <div className="border border-gray-300 shadow-md p-6 rounded-xl max-w-xl bg-white hover:shadow-lg transition duration-200">
      ...
      <p className="mb-2 cursor-pointer text-amber-900" onClick={() => { setShowMembers(!showMembers); getAllMembers(task._id) }}>
        click to see members <span className="text-green-500">⮯</span>
      </p>
